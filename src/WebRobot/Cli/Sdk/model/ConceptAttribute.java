...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/rgodb61otb-1.0.0/ConceptAttribute" target="_top">AWS API
 *      Documentation</a>
 */
...
public class ConceptAttribute implements Serializable, Cloneable, StructuredPojo {
    ...
    public ConceptAttribute botId(String botId) {
        setBotId(botId);
        return this;
    }
    ...
    public ConceptAttribute conceptId(String conceptId) {
    ...
    public ConceptAttribute typeAttribute(String typeAttribute) {
    ...
    public String toString() {
        ...
        if (getTypeAttribute() != null)
            sb.append("TypeAttribute: ").append(getTypeAttribute()).append(",");
        if (getUri() != null)
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        WebRobot.Cli.Sdk.model.transform.ConceptAttributeMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
