...
public class Export_allResult extends BaseResultException {
    ...
    public Export_allResult stringResult(StringResult stringResult) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Export_allResult == false)
            return false;
        Export_allResult other = (Export_allResult) obj;
    ...
    @Override
    public Export_allResult clone() {
        try {
            return (Export_allResult) super.clone();
