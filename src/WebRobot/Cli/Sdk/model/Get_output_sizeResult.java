...
public class Get_output_sizeResult extends BaseResultException {
    ...
    public Get_output_sizeResult datasetSize(DatasetSize datasetSize) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_output_sizeResult == false)
            return false;
        Get_output_sizeResult other = (Get_output_sizeResult) obj;
    ...
    @Override
    public Get_output_sizeResult clone() {
        try {
            return (Get_output_sizeResult) super.clone();
