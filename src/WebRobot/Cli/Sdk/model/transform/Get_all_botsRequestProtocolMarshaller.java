...
public class Get_all_botsRequestProtocolMarshaller implements Marshaller<Request<Get_all_botsRequest>, Get_all_botsRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.API_GATEWAY)
            .requestUri("/test/webrobot/api/bots/{projectId}").httpMethodName(HttpMethodName.GET).hasExplicitPayloadMember(false).hasPayloadMembers(false)
            .serviceName("WebRobotCliSdk").build();

    private final ApiGatewayProtocolFactoryImplTest protocolFactory;

    public Get_all_botsRequestProtocolMarshaller(ApiGatewayProtocolFactoryImplTest protocolFactory) {
