...
public class Get_dataset_statusRequestProtocolMarshaller implements Marshaller<Request<Get_dataset_statusRequest>, Get_dataset_statusRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.API_GATEWAY)
            .requestUri("/test/webrobot/api/datasets/{projectId}/{botId}/{datasetId}/status").httpMethodName(HttpMethodName.GET)
    ...
    public Get_dataset_statusRequestProtocolMarshaller(ApiGatewayProtocolFactoryImplTest protocolFactory) {
