...
public class ConceptAttributeMarshaller {
    ...
    private static final MarshallingInfo<String> TYPEATTRIBUTE_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("typeAttribute").build();
    ...
    public void marshall(ConceptAttribute conceptAttribute, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(conceptAttribute.getBotId(), BOTID_BINDING);
            protocolMarshaller.marshall(conceptAttribute.getConceptId(), CONCEPTID_BINDING);
            ...
            protocolMarshaller.marshall(conceptAttribute.getTypeAttribute(), TYPEATTRIBUTE_BINDING);
