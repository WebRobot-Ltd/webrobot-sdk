...
public class ConceptMarshaller {
    ...
    private static final MarshallingInfo<String> BOIID_BINDING = MarshallingInfo.builder(MarshallingType.STRING).marshallLocation(MarshallLocation.PAYLOAD)
            .marshallLocationName("boiId").build();
    ...
    public void marshall(Concept concept, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(concept.getBoiId(), BOIID_BINDING);
