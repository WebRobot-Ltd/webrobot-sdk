...
public class PageMarshaller {
    ...
    public void marshall(Page page, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(page.getAttributes(), ATTRIBUTES_BINDING);
            ...
            protocolMarshaller.marshall(page.getHtml(), HTML_BINDING);
            protocolMarshaller.marshall(page.getId(), ID_BINDING);
