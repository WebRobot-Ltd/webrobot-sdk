...
public class Create_botRequestProtocolMarshaller implements Marshaller<Request<Create_botRequest>, Create_botRequest> {
    ...
    private static final OperationInfo SDK_OPERATION_BINDING = OperationInfo.builder().protocol(Protocol.API_GATEWAY)
            .requestUri("/test/webrobot/api/bots/{projectId}").httpMethodName(HttpMethodName.POST).hasExplicitPayloadMember(true).hasPayloadMembers(true)
            .serviceName("WebRobotCliSdk").build();

    private final ApiGatewayProtocolFactoryImplTest protocolFactory;

    public Create_botRequestProtocolMarshaller(ApiGatewayProtocolFactoryImplTest protocolFactory) {
