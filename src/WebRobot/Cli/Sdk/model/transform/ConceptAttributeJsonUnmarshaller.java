        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("botId", targetDepth)) {
                    context.nextToken();
                    conceptAttribute.setBotId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("conceptId", targetDepth)) {
                    context.nextToken();
                    conceptAttribute.setConceptId(context.getUnmarshaller(String.class).unmarshall(context));
                }
                ...
                if (context.testExpression("typeAttribute", targetDepth)) {
                    context.nextToken();
                    conceptAttribute.setTypeAttribute(context.getUnmarshaller(String.class).unmarshall(context));
                }
