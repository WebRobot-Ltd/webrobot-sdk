        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                ...
                if (context.testExpression("attributes", targetDepth)) {
                    context.nextToken();
                    page.setAttributes(new ListUnmarshaller<PageAttribute>(PageAttributeJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                ...
                if (context.testExpression("html", targetDepth)) {
                    context.nextToken();
                    page.setHtml(context.getUnmarshaller(String.class).unmarshall(context));
                }
                if (context.testExpression("id", targetDepth)) {
                    context.nextToken();
                    page.setId(context.getUnmarshaller(String.class).unmarshall(context));
                }
