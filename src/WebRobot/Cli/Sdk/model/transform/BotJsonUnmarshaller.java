    ...
    public Bot unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("botParameters", targetDepth)) {
                    context.nextToken();
                    bot.setBotParameters(new ListUnmarshaller<BotParametersElement>(BotParametersElementJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                ...
                if (context.testExpression("sparqlService", targetDepth)) {
                    context.nextToken();
