...
public class JobMarshaller {
    ...
    private static final MarshallingInfo<String> SPARKJOBID_BINDING = MarshallingInfo.builder(MarshallingType.STRING)
            .marshallLocation(MarshallLocation.PAYLOAD).marshallLocationName("sparkJobId").build();
    ...
    public void marshall(Job job, ProtocolMarshaller protocolMarshaller) {
        ...
        try {
            ...
            protocolMarshaller.marshall(job.getSparkJobId(), SPARKJOBID_BINDING);
