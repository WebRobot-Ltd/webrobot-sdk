...
public class Get_dataset_versionsResult extends BaseResultException {
    ...
    public Get_dataset_versionsResult listDatasetVersions(ListDatasetVersions listDatasetVersions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_dataset_versionsResult == false)
            return false;
        Get_dataset_versionsResult other = (Get_dataset_versionsResult) obj;
    ...
    @Override
    public Get_dataset_versionsResult clone() {
        try {
            return (Get_dataset_versionsResult) super.clone();
