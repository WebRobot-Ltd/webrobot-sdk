...
public class Get_dataset_versionResult extends BaseResultException {
    ...
    public Get_dataset_versionResult datasetVersion(DatasetVersion datasetVersion) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_dataset_versionResult == false)
            return false;
        Get_dataset_versionResult other = (Get_dataset_versionResult) obj;
    ...
    @Override
    public Get_dataset_versionResult clone() {
        try {
            return (Get_dataset_versionResult) super.clone();
