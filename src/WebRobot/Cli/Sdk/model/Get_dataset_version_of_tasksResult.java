...
public class Get_dataset_version_of_tasksResult extends BaseResultException {
    ...
    public Get_dataset_version_of_tasksResult listDatasetVersions(ListDatasetVersions listDatasetVersions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_dataset_version_of_tasksResult == false)
            return false;
        Get_dataset_version_of_tasksResult other = (Get_dataset_version_of_tasksResult) obj;
    ...
    @Override
    public Get_dataset_version_of_tasksResult clone() {
        try {
            return (Get_dataset_version_of_tasksResult) super.clone();
