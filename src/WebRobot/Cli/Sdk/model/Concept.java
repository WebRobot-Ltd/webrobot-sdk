...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/rgodb61otb-1.0.0/Concept" target="_top">AWS API
 *      Documentation</a>
 */
...
public class Concept implements Serializable, Cloneable, StructuredPojo {
    ...
    public void setBoiId(String boiId) {
        this.boiId = boiId;
    }
    ...
    public Concept boiId(String boiId) {
        setBoiId(boiId);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getBoiId() != null)
            sb.append("BoiId: ").append(getBoiId()).append(",");
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getAttributes() != null && other.getAttributes().equals(this.getAttributes()) == false)
            return false;
        if (other.getBoiId() == null ^ this.getBoiId() == null)
            return false;
        if (other.getBoiId() != null && other.getBoiId().equals(this.getBoiId()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getBoiId() == null) ? 0 : getBoiId().hashCode());
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        WebRobot.Cli.Sdk.model.transform.ConceptMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
