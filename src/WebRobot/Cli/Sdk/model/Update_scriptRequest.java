...
public class Update_scriptRequest extends com.amazonaws.opensdk.BaseRequest implements Serializable, Cloneable {
    ...
    public Update_scriptRequest botId(String botId) {
        setBotId(botId);
        return this;
    }
    ...
    public Update_scriptRequest botScript(BotScript botScript) {
    ...
    public Update_scriptRequest projectId(String projectId) {
    ...
    public Update_scriptRequest scriptId(String scriptId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Update_scriptRequest == false)
            return false;
        Update_scriptRequest other = (Update_scriptRequest) obj;
    ...
    @Override
    public Update_scriptRequest clone() {
        return (Update_scriptRequest) super.clone();
    }
     ...
     */
    public Update_scriptRequest sdkRequestConfig(com.amazonaws.opensdk.SdkRequestConfig sdkRequestConfig) {
