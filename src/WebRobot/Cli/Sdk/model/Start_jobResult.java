...
public class Start_jobResult extends BaseResultException {
    ...
    public Start_jobResult job(Job job) {
        setJob(job);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Start_jobResult == false)
            return false;
        Start_jobResult other = (Start_jobResult) obj;
    ...
    @Override
    public Start_jobResult clone() {
        try {
            return (Start_jobResult) super.clone();
