...
public class Get_concept_from_idRequest extends com.amazonaws.opensdk.BaseRequest implements Serializable, Cloneable {
    ...
    public Get_concept_from_idRequest botId(String botId) {
        setBotId(botId);
        return this;
    }
    ...
    public Get_concept_from_idRequest conceptId(String conceptId) {
    ...
    public Get_concept_from_idRequest projectId(String projectId) {
    ...
    public Get_concept_from_idRequest typeAttribute(String typeAttribute) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_concept_from_idRequest == false)
            return false;
        Get_concept_from_idRequest other = (Get_concept_from_idRequest) obj;
    ...
    @Override
    public Get_concept_from_idRequest clone() {
        return (Get_concept_from_idRequest) super.clone();
    }
     ...
     */
    public Get_concept_from_idRequest sdkRequestConfig(com.amazonaws.opensdk.SdkRequestConfig sdkRequestConfig) {
