...
public class Get_list_versions_jobResult extends BaseResultException {
    ...
    public Get_list_versions_jobResult listDatasetVersions(ListDatasetVersions listDatasetVersions) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_list_versions_jobResult == false)
            return false;
        Get_list_versions_jobResult other = (Get_list_versions_jobResult) obj;
    ...
    @Override
    public Get_list_versions_jobResult clone() {
        try {
            return (Get_list_versions_jobResult) super.clone();
