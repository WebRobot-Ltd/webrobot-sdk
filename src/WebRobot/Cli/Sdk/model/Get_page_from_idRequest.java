...
public class Get_page_from_idRequest extends com.amazonaws.opensdk.BaseRequest implements Serializable, Cloneable {
    ...
    public Get_page_from_idRequest botId(String botId) {
        setBotId(botId);
        return this;
    }
    ...
    public Get_page_from_idRequest conceptId(String conceptId) {
    ...
    public Get_page_from_idRequest pageId(String pageId) {
        setPageId(pageId);
        return this;
    }
    ...
    public Get_page_from_idRequest projectId(String projectId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_page_from_idRequest == false)
            return false;
        Get_page_from_idRequest other = (Get_page_from_idRequest) obj;
    ...
    @Override
    public Get_page_from_idRequest clone() {
        return (Get_page_from_idRequest) super.clone();
    }
     ...
     */
    public Get_page_from_idRequest sdkRequestConfig(com.amazonaws.opensdk.SdkRequestConfig sdkRequestConfig) {
