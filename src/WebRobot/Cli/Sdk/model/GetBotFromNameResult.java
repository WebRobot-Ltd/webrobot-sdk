...
public class GetBotFromNameResult extends BaseResultException {
    ...
    public GetBotFromNameResult bot(Bot bot) {
        setBot(bot);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof GetBotFromNameResult == false)
            return false;
        GetBotFromNameResult other = (GetBotFromNameResult) obj;
    ...
    @Override
    public GetBotFromNameResult clone() {
        try {
            return (GetBotFromNameResult) super.clone();
