...
public class Get_attribute_from_idResult extends BaseResultException {
    ...
    public Get_attribute_from_idResult conceptAttribute(ConceptAttribute conceptAttribute) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_attribute_from_idResult == false)
            return false;
        Get_attribute_from_idResult other = (Get_attribute_from_idResult) obj;
    ...
    @Override
    public Get_attribute_from_idResult clone() {
        try {
            return (Get_attribute_from_idResult) super.clone();
