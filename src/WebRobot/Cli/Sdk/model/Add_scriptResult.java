...
public class Add_scriptResult extends BaseResultException {
    ...
    public Add_scriptResult botScript(BotScript botScript) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Add_scriptResult == false)
            return false;
        Add_scriptResult other = (Add_scriptResult) obj;
    ...
    @Override
    public Add_scriptResult clone() {
        try {
            return (Add_scriptResult) super.clone();
