...
public class Update_scriptResult extends BaseResultException {
    ...
    public Update_scriptResult botScript(BotScript botScript) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Update_scriptResult == false)
            return false;
        Update_scriptResult other = (Update_scriptResult) obj;
    ...
    @Override
    public Update_scriptResult clone() {
        try {
            return (Update_scriptResult) super.clone();
