...
public class Get_jobResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public Get_jobResult job(Job job) {
        setJob(job);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_jobResult == false)
            return false;
        Get_jobResult other = (Get_jobResult) obj;
    ...
    @Override
    public Get_jobResult clone() {
        try {
            return (Get_jobResult) super.clone();
