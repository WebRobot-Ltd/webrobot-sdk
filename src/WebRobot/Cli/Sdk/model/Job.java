...
/**
 * 
 * @see <a href="http://docs.aws.amazon.com/goto/WebAPI/rgodb61otb-1.0.0/Job" target="_top">AWS API Documentation</a>
 */
...
public class Job implements Serializable, Cloneable, StructuredPojo {
    ...
    public Job sparkJobId(String sparkJobId) {
        setSparkJobId(sparkJobId);
        return this;
    }
    ...
    public String toString() {
        ...
        if (getSparkJobId() != null)
            sb.append("SparkJobId: ").append(getSparkJobId()).append(",");
        if (getStatus() != null)
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getScheduleInfo() != null && other.getScheduleInfo().equals(this.getScheduleInfo()) == false)
            return false;
        if (other.getSparkJobId() == null ^ this.getSparkJobId() == null)
            return false;
        if (other.getSparkJobId() != null && other.getSparkJobId().equals(this.getSparkJobId()) == false)
            return false;
    ...
    public int hashCode() {
        ...
        hashCode = prime * hashCode + ((getSparkJobId() == null) ? 0 : getSparkJobId().hashCode());
    ...
    public void marshall(ProtocolMarshaller protocolMarshaller) {
        WebRobot.Cli.Sdk.model.transform.JobMarshaller.getInstance().marshall(this, protocolMarshaller);
    }
}
