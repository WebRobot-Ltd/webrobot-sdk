...
public class Add_datasetResult extends BaseResultException {
    ...
    public Add_datasetResult dataset(Dataset dataset) {
        setDataset(dataset);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Add_datasetResult == false)
            return false;
        Add_datasetResult other = (Add_datasetResult) obj;
    ...
    @Override
    public Add_datasetResult clone() {
        try {
            return (Add_datasetResult) super.clone();
