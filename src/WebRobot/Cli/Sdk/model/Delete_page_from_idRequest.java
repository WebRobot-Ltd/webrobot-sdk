...
public class Delete_page_from_idRequest extends com.amazonaws.opensdk.BaseRequest implements Serializable, Cloneable {
    ...
    public Delete_page_from_idRequest botId(String botId) {
        setBotId(botId);
        return this;
    }
    ...
    public Delete_page_from_idRequest conceptId(String conceptId) {
    ...
    public Delete_page_from_idRequest pageId(String pageId) {
        setPageId(pageId);
        return this;
    }
    ...
    public Delete_page_from_idRequest projectId(String projectId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Delete_page_from_idRequest == false)
            return false;
        Delete_page_from_idRequest other = (Delete_page_from_idRequest) obj;
    ...
    @Override
    public Delete_page_from_idRequest clone() {
        return (Delete_page_from_idRequest) super.clone();
    }
     ...
     */
    public Delete_page_from_idRequest sdkRequestConfig(com.amazonaws.opensdk.SdkRequestConfig sdkRequestConfig) {
