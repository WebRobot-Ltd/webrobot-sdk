...
public class Export_projectResult extends BaseResultException {
    ...
    public Export_projectResult stringResult(StringResult stringResult) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Export_projectResult == false)
            return false;
        Export_projectResult other = (Export_projectResult) obj;
    ...
    @Override
    public Export_projectResult clone() {
        try {
            return (Export_projectResult) super.clone();
