...
public class Get_concept_attribute_from_nameResult extends BaseResultException {
    ...
    public Get_concept_attribute_from_nameResult conceptAttribute(ConceptAttribute conceptAttribute) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_concept_attribute_from_nameResult == false)
            return false;
        Get_concept_attribute_from_nameResult other = (Get_concept_attribute_from_nameResult) obj;
    ...
    @Override
    public Get_concept_attribute_from_nameResult clone() {
        try {
            return (Get_concept_attribute_from_nameResult) super.clone();
