...
public class Get_dataset_version_file_paginationResult extends BaseResultException {
    ...
    public Get_dataset_version_file_paginationResult listRecords(ListRecords listRecords) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_dataset_version_file_paginationResult == false)
            return false;
        Get_dataset_version_file_paginationResult other = (Get_dataset_version_file_paginationResult) obj;
    ...
    @Override
    public Get_dataset_version_file_paginationResult clone() {
        try {
            return (Get_dataset_version_file_paginationResult) super.clone();
