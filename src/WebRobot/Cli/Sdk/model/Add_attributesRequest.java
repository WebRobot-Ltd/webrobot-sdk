...
public class Add_attributesRequest extends com.amazonaws.opensdk.BaseRequest implements Serializable, Cloneable {
    ...
    public Add_attributesRequest botId(String botId) {
        setBotId(botId);
        return this;
    }
    ...
    public Add_attributesRequest conceptAttribute(ConceptAttribute conceptAttribute) {
    ...
    public Add_attributesRequest conceptId(String conceptId) {
    ...
    public Add_attributesRequest projectId(String projectId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Add_attributesRequest == false)
            return false;
        Add_attributesRequest other = (Add_attributesRequest) obj;
    ...
    @Override
    public Add_attributesRequest clone() {
        return (Add_attributesRequest) super.clone();
    }
     ...
     */
    public Add_attributesRequest sdkRequestConfig(com.amazonaws.opensdk.SdkRequestConfig sdkRequestConfig) {
