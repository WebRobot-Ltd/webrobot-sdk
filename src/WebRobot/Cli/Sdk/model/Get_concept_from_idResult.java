...
public class Get_concept_from_idResult extends BaseResultException {
    ...
    public Get_concept_from_idResult concept(Concept concept) {
        setConcept(concept);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_concept_from_idResult == false)
            return false;
        Get_concept_from_idResult other = (Get_concept_from_idResult) obj;
    ...
    @Override
    public Get_concept_from_idResult clone() {
        try {
            return (Get_concept_from_idResult) super.clone();
