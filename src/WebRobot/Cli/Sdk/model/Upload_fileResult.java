...
public class Upload_fileResult extends BaseResultException {
    ...
    public Upload_fileResult stringResult(StringResult stringResult) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Upload_fileResult == false)
            return false;
        Upload_fileResult other = (Upload_fileResult) obj;
    ...
    @Override
    public Upload_fileResult clone() {
        try {
            return (Upload_fileResult) super.clone();
