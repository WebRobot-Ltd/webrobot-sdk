...
public class Get_url_downloadResult extends BaseResultException {
    ...
    public Get_url_downloadResult stringResult(StringResult stringResult) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_url_downloadResult == false)
            return false;
        Get_url_downloadResult other = (Get_url_downloadResult) obj;
    ...
    @Override
    public Get_url_downloadResult clone() {
        try {
            return (Get_url_downloadResult) super.clone();
