...
public class Add_attributesResult extends BaseResultException {
    ...
    public Add_attributesResult conceptAttribute(ConceptAttribute conceptAttribute) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Add_attributesResult == false)
            return false;
        Add_attributesResult other = (Add_attributesResult) obj;
    ...
    @Override
    public Add_attributesResult clone() {
        try {
            return (Add_attributesResult) super.clone();
