...
public class Get_dataset_version_fileResult extends BaseResultException {
    ...
    public Get_dataset_version_fileResult stringResult(StringResult stringResult) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Get_dataset_version_fileResult == false)
            return false;
        Get_dataset_version_fileResult other = (Get_dataset_version_fileResult) obj;
    ...
    @Override
    public Get_dataset_version_fileResult clone() {
        try {
            return (Get_dataset_version_fileResult) super.clone();
