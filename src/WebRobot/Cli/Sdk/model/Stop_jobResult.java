...
public class Stop_jobResult extends BaseResultException {
    ...
    public Stop_jobResult job(Job job) {
        setJob(job);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Stop_jobResult == false)
            return false;
        Stop_jobResult other = (Stop_jobResult) obj;
    ...
    @Override
    public Stop_jobResult clone() {
        try {
            return (Stop_jobResult) super.clone();
