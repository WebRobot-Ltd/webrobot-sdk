...
import WebRobot.Cli.Sdk.WebRobotSdk;
import WebRobot.Cli.Sdk.handlers.GetDatasetInputFileResponseHandler;
import WebRobot.Cli.Sdk.handlers.GetOutputFileResultResponseHandler;
...
/**
 * Client for accessing WebRobotSdk. All service calls made using this client are blocking, and will not return until
...
class WebRobotSdkClient implements WebRobotSdk {
    ...
    private static final com.amazonaws.opensdk.protect.protocol.ApiGatewayProtocolFactoryImpl protocolFactory = new com.amazonaws.opensdk.protect.protocol.ApiGatewayProtocolFactoryImpl(
            new JsonClientMetadata().withProtocolVersion("1.1").withSupportsCbor(false).withSupportsIon(false).withContentTypeOverride("application/json")
                    .withBaseServiceExceptionClass(WebRobotSdkException.class));


    /**
     * Constructs a new client to invoke service methods on WebRobotSdk using the specified parameters.
     *
     * <p>
     ...
     */
    WebRobotSdkClient(AwsSyncClientParams clientParams) {
     ...
     * @sample WebRobotSdk.add_attributes
     ...
     * @sample WebRobotSdk.add_dataset
     ...
     * @sample WebRobotSdk.create_concept
     ...
     * @sample WebRobotSdk.create_page
     ...
     * @sample WebRobotSdk.create_project
     ...
     * @sample WebRobotSdk.delete dataset from id
     ...
     * @sample WebRobotSdk.delete_attribute
     ...
     * @sample WebRobotSdk.delete_concept
     ...
     * @sample WebRobotSdk.delete_dataset_version__from_id
     ...
     * @sample WebRobotSdk.delete_page_from_id
     ...
     * @sample WebRobotSdk.delete_project
     ...
     * @sample WebRobotSdk.delete_script
     ...
     * @sample WebRobotSdk.get bot from id
     ...
     * @sample WebRobotSdk.get bot from name
     ...
     * @sample WebRobotSdk.get_all_attributes
     ...
     * @sample WebRobotSdk.get_all_bots
     ...
     * @sample WebRobotSdk.get_all_concepts
     ...
     * @sample WebRobotSdk.get_all_datasets
     ...
     * @sample WebRobotSdk.get_all_jobs
     ...
     * @sample WebRobotSdk.get_all_pages
     ...
     * @sample WebRobotSdk.get_all_projects
     ...
     * @sample WebRobotSdk.get_attribute_from_id
     ...
     * @sample WebRobotSdk.get_attribute_from_name
     ...
     * @sample WebRobotSdk.get_attribute_from_page
     ...
     * @sample WebRobotSdk.get_concept_attribute_from_name
     ...
     * @sample WebRobotSdk.get_concept_from_id
     ...
     * @sample WebRobotSdk.get_concept_from_name
     ...
     * @sample WebRobotSdk.get_dataset
     ...
     * @sample WebRobotSdk.get_dataset_input_file
    ...
    public Get_dataset_input_fileResult get_dataset_input_file(Get_dataset_input_fileRequest get_dataset_input_fileRequest) {
        HttpResponseHandler<Get_dataset_input_fileResult> responseHandler = new GetDatasetInputFileResponseHandler();
        HttpResponseHandler<SdkBaseException> errorResponseHandler = createErrorResponseHandler();
     ...
     * @sample WebRobotSdk.get_dataset_input_file_pagination
     ...
     * @sample WebRobotSdk.get_dataset_input_size
     ...
     * @sample WebRobotSdk.get_dataset_status
     ...
     * @sample WebRobotSdk.get_dataset_version
     ...
     * @sample WebRobotSdk.get_dataset_version_file
     ...
     * @sample WebRobotSdk.get_dataset_version_file_pagination
     ...
     * @sample WebRobotSdk.get_dataset_version_from_id
     ...
     * @sample WebRobotSdk.get_dataset_versions
     ...
     * @sample WebRobotSdk.get_output_file
    ...
    public Get_output_fileResult get_output_file(Get_output_fileRequest get_output_fileRequest) {
        HttpResponseHandler<Get_output_fileResult> responseHandler = new GetOutputFileResultResponseHandler();
        HttpResponseHandler<SdkBaseException> errorResponseHandler = createErrorResponseHandler();
     ...
     * @sample WebRobotSdk.get_output_file_pagination
     ...
     * @sample WebRobotSdk.get_output_size
     ...
     * @sample WebRobotSdk.get_page_from_id
     ...
     * @sample WebRobotSdk.get_project
     ...
     * @sample WebRobotSdk.get_project_from_name
     ...
     * @sample WebRobotSdk.get_scripts
     ...
     * @sample WebRobotSdk.get_status_job
     ...
     * @sample WebRobotSdk.update_attribute
     ...
     * @sample WebRobotSdk.update_concept
     ...
     * @sample WebRobotSdk.update_page
     ...
     * @sample WebRobotSdk.update_project
     ...
     * @sample WebRobotSdk.update_script
     ...
     * @sample WebRobotSdk.upload_file
